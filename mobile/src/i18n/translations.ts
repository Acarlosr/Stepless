    ...
    translation: {
      ...
      rewards: {
        ...
        send: {
          ...
          sending: 'Enviando...',
          success: 'Enviado!',
          successMessage: 'Transferência concluída na Arc Testnet.',
          viewOnArcscan: 'Ver no ArcScan',
          invalidAddress: 'Endereço inválido. Confira o código 0x... do destino.',
          invalidAmount: 'Informe um valor válido maior que zero.',
          insufficient: 'Saldo insuficiente para enviar esse valor.',
          errorGeneric: 'Não foi possível enviar agora. Verifique sua conexão e tente novamente.',
          networkWarning: 'Envie apenas para endereços na rede Arc Testnet. Enviar para outra rede pode causar perda dos fundos.',
          helpTitle: 'Como sacar suas recompensas',
          helpText: 'Você pode enviar USDC para outra carteira ou pessoa. Para converter em dinheiro, envie para uma corretora que aceite USDC — sempre conferindo a rede. Sua carteira é sua: a chave pode ser exportada no Perfil.',
          helpLink: 'Ver guia completo',
        },
        types: {
    ...
    translation: {
      ...
      rewards: {
        ...
        send: {
          ...
          sending: 'Sending...',
          success: 'Sent!',
          successMessage: 'Transfer completed on Arc Testnet.',
          viewOnArcscan: 'View on ArcScan',
          invalidAddress: 'Invalid address. Check the destination 0x... code.',
          invalidAmount: 'Enter a valid amount greater than zero.',
          insufficient: 'Insufficient balance to send this amount.',
          errorGeneric: 'Could not send right now. Check your connection and try again.',
          networkWarning: 'Only send to addresses on the Arc Testnet network. Sending to another network may cause loss of funds.',
          helpTitle: 'How to withdraw your rewards',
          helpText: 'You can send USDC to another wallet or person. To convert to cash, send it to an exchange that accepts USDC — always double-checking the network. Your wallet is yours: the key can be exported in Profile.',
          helpLink: 'See full guide',
        },
        types: {
    ...
    translation: {
      ...
      rewards: {
        ...
        send: {
          ...
          sending: 'Enviando...',
          success: '¡Enviado!',
          successMessage: 'Transferencia completada en Arc Testnet.',
          viewOnArcscan: 'Ver en ArcScan',
          invalidAddress: 'Dirección inválida. Verifica el código 0x... del destino.',
          invalidAmount: 'Ingresa un monto válido mayor que cero.',
          insufficient: 'Saldo insuficiente para enviar este monto.',
          errorGeneric: 'No se pudo enviar ahora. Verifica tu conexión e inténtalo de nuevo.',
          networkWarning: 'Envía solo a direcciones en la red Arc Testnet. Enviar a otra red puede causar la pérdida de los fondos.',
          helpTitle: 'Cómo retirar tus recompensas',
          helpText: 'Puedes enviar USDC a otra billetera o persona. Para convertirlo en dinero, envíalo a un exchange que acepte USDC — verificando siempre la red. Tu billetera es tuya: la clave puede exportarse en Perfil.',
          helpLink: 'Ver guía completa',
        },
        types: {
