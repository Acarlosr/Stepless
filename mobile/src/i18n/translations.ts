  ...
  'pt-BR': {
    translation: {
      ...
      map: {
        ...
        category_hint: 'Marque todas as opções que se aplicam.',
        select_category: 'Marque pelo menos uma categoria.',
        verified: 'Verificado',
        pending: 'Pendente',
      ...
      rewards: {
        ...
        treasury: {
          title: 'Financie Rampas Reais',
          note: 'As recompensas saem da tesouraria do contrato, financiada por patrocinadores — tudo público on-chain.',
          cta: 'Ver patrocinadores na web',
        },
        withdraw: 'Sacar',
      ...
      profile: {
        ...
        version: 'Versão',
        walletPortability: 'Levar sua carteira para outro lugar',
        walletPortabilityDesc: 'Sua carteira foi criada com seu e-mail e vive dentro do Stepless. Se quiser usá-la em outro app, como o MetaMask, você pode exportar a chave privada e importá-la lá. Seu endereço e seu saldo continuam os mesmos.',
        exportKeyButton: 'Exportar chave privada',
        exportKeyTitle: 'Exportar chave privada',
        exportKeyWarning: 'Quem tiver essa chave controla sua carteira e pode gastar seu saldo. Nunca compartilhe com ninguém, nem com o suporte do Stepless. Deseja continuar?',
        exportKeyContinue: 'Continuar',
        exportKeyLoading: 'Preparando...',
        exportKeyError: 'Não foi possível exportar a chave agora. Tente novamente.',
        exportKeyLabel: 'Sua chave privada',
        exportKeyNeverShare: 'Nunca tire print, envie por mensagem ou digite essa chave em sites. Qualquer pessoa com ela pode roubar seu saldo.',
        exportKeyCopy: 'Copiar chave',
        exportKeyCopied: 'Copiado!',
        exportKeyHint: 'Cole essa chave na opção "Importar carteira" do MetaMask ou de outro app compatível com Ethereum/Arc.',
        exportKeyDone: 'Concluído',
  ...
  'en': {
    translation: {
      ...
      map: {
        ...
        category_hint: 'Check all options that apply.',
        select_category: 'Check at least one category.',
        verified: 'Verified',
        pending: 'Pending',
      ...
      rewards: {
        ...
        treasury: {
          title: 'Fund Real Ramps',
          note: 'Rewards come from the contract treasury, funded by sponsors — all public on-chain.',
          cta: 'See sponsors on the web',
        },
        withdraw: 'Withdraw',
      ...
      profile: {
        ...
        version: 'Version',
        walletPortability: 'Take your wallet elsewhere',
        walletPortabilityDesc: 'Your wallet was created with your email and lives inside Stepless. If you want to use it in another app, like MetaMask, you can export the private key and import it there. Your address and balance stay the same.',
        exportKeyButton: 'Export private key',
        exportKeyTitle: 'Export private key',
        exportKeyWarning: 'Whoever has this key controls your wallet and can spend your balance. Never share it with anyone, not even Stepless support. Continue?',
        exportKeyContinue: 'Continue',
        exportKeyLoading: 'Preparing...',
        exportKeyError: 'Could not export the key right now. Please try again.',
        exportKeyLabel: 'Your private key',
        exportKeyNeverShare: 'Never screenshot, message, or type this key into a website. Anyone who has it can steal your balance.',
        exportKeyCopy: 'Copy key',
        exportKeyCopied: 'Copied!',
        exportKeyHint: 'Paste this key into MetaMask\'s "Import wallet" option or any other Ethereum/Arc-compatible app.',
        exportKeyDone: 'Done',
  ...
  'es': {
    translation: {
      ...
      map: {
        ...
        category_hint: 'Marca todas las opciones que apliquen.',
        select_category: 'Marca por lo menos una categoría.',
        verified: 'Verificado',
        pending: 'Pendiente',
      ...
      rewards: {
        ...
        treasury: {
          title: 'Financia Rampas Reales',
          note: 'Las recompensas salen de la tesorería del contrato, financiada por patrocinadores — todo público on-chain.',
          cta: 'Ver patrocinadores en la web',
        },
        withdraw: 'Retirar',
      ...
      profile: {
        ...
        version: 'Versión',
        walletPortability: 'Llevar tu billetera a otro lugar',
        walletPortabilityDesc: 'Tu billetera se creó con tu correo y vive dentro de Stepless. Si quieres usarla en otra app, como MetaMask, puedes exportar la clave privada e importarla ahí. Tu dirección y tu saldo siguen siendo los mismos.',
        exportKeyButton: 'Exportar clave privada',
        exportKeyTitle: 'Exportar clave privada',
        exportKeyWarning: 'Quien tenga esta clave controla tu billetera y puede gastar tu saldo. Nunca la compartas con nadie, ni con el soporte de Stepless. ¿Deseas continuar?',
        exportKeyContinue: 'Continuar',
        exportKeyLoading: 'Preparando...',
        exportKeyError: 'No se pudo exportar la clave ahora. Inténtalo de nuevo.',
        exportKeyLabel: 'Tu clave privada',
        exportKeyNeverShare: 'Nunca tomes captura, envíes por mensaje ni escribas esta clave en sitios web. Cualquiera que la tenga puede robar tu saldo.',
        exportKeyCopy: 'Copiar clave',
        exportKeyCopied: '¡Copiado!',
        exportKeyHint: 'Pega esta clave en la opción "Importar billetera" de MetaMask o de otra app compatible con Ethereum/Arc.',
        exportKeyDone: 'Listo',
